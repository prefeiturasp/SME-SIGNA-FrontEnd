...
export const SiderSubMenuContainer = styled(SubMenu)<SiderSubMenuStylePros>`
  &.ant-menu-submenu {
    width: ${(props) => (props.collapsed ? '97px' : '224px')};
    background: white;
    ...
    & {
      :not(.ant-menu-submenu-open) {
        ...
        background: ${(props) => (props?.isSubMenu ? 'white' :'#B22B2A')};
    ...
    .ant-menu-submenu-title {
      ...
      height: ${(props) => (props?.collapsed ? '72px' : '40px')} !important;
...
export const SiderMenuContainer = styled.div<SiderMenuStylePros>`
  ...
  .ant-menu-light.ant-menu-root.ant-menu-inline {
    ...
    ${(props) => props?.collapsed && `padding: 0px;`}
  }
...
export const SiderIconContainer = styled.div<SiderMenuStylePros>`
  ...
  svg,
  i {
    color: ${(props) => (props.$hasRedBackground ? '#fff' : '#B22B2A')};
    height: ${(props) => (props.collapsed ? '24px' : '22px')};
    width: ${(props) => (props.collapsed ? '24px' : '22px')};
    font-size: 18px;
  }
`;
