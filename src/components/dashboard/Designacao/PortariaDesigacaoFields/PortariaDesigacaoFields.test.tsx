...
import FormularioPesquisaUnidade from "./PortariaDesigacaoFields";
...
import type { FormularioPesquisaUnidadeRef } from "./PortariaDesigacaoFields";
...
describe("FormularioPesquisaUnidade", () => {
  ...
  it("coverage: usa fallback '-' no DetalhamentoTurmasModal quando valores são nullish", async () => {
    ...
    const { default: FormularioPesquisaUnidadeIsolated } = await import("./PortariaDesigacaoFields");
