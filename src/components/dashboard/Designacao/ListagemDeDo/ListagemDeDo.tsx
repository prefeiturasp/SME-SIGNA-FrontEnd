...
interface ListagemDeDoProps {
  ...
  isLoading?: boolean;
  onClickAlterarDataDo?: (rows: ListagemPortariasResponse[]) => void;
  onClickBaixarLauda?: (rows: ListagemPortariasResponse[], tipoArquivo: string) => void;
  isDisabled?: boolean;
  ...
  return (
    <div className="flex flex-col gap-1 bg-white  ">
      ...
      <div className="w-full pb-2">
        ...
        <div className="flex items-start justify-start gap-16 pl-2 pt-8">
            ...
            {isListagemDo ?
              ...
              <Dropdown  menu={{
                items: [
                  {
                    key: '0',
                    label: <div className="text-sm font-bold">Tipo de arquivo:</div>,
                  },
                  {
                    key: '1',
                    label: 'PDF',
                    onClick: () => {
                      onClickBaixarLauda(selectedRows, 'PDF');
                    },
                  },
                  {
                    key: '2',
                    label: 'CSV',
                    onClick: () => {
                      onClickBaixarLauda(selectedRows, 'CSV');
                    },
                  },
                  {
                    key: '3',
                    label: 'Word',
                    onClick: () => {
                      onClickBaixarLauda(selectedRows, 'WORD');
                    },
                  },
                ]
              }} placement="top">
