    ...
    ({ className, type, value, ...props }, ref) => {
        ...
        return (
            <input
                type={type}
                className={cn(
                    "flex h-10 w-full border border-[#dadada] bg-background px-3 py-2 text-sm font-medium ring-0 ring-offset-0 shadow-none outline-hidden focus:outline-hidden focus:ring-0 focus:ring-offset-0 focus:shadow-none focus:bg-[#E8F0FE] focus:border-[#ced4da] disabled:cursor-not-allowed rounded-[4px]",
