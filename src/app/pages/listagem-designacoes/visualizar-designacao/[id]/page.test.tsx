...
describe("VisualizarDesignacao page", () => {
  ...
  it("navega ao clicar nos botões do cabeçalho", () => {
    ...
    expect(pushMock).toHaveBeenNthCalledWith(1, "/pages/historico-ato-administrativo?id=12&tipo=undefined&tipo_display=Designação&ato_raiz_id=undefined&portaria=001&servidor_indicado=INDICADO");
  });
